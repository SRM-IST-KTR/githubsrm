...
import { MaintainerFormData } from "../../../utils/interfaces";

const Maintainer = () => {
  let [stage, setStage] = useState<number>(0);

  const initialValues: Partial<MaintainerFormData> = {};

  const submitValues = (values: MaintainerFormData) => {
    //*INFO: api call here
    console.log(values);
  };
  ...
  return (
    <div>
      ...
      <Formik
        ...
        validationSchema={maintainerValidationSchema}
      >
        {({ errors, touched }) => (
